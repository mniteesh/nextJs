...
const getStaticPaths = async () => {
  const client = await external_mongodb_["MongoClient"].connect("mongodb+srv://Mniteesh:DaXs6cR4Ne9tkLk9@cluster0.3ds1l.mongodb.net/meetUp?retryWrites=true&w=majority");
  const db = client.db();
